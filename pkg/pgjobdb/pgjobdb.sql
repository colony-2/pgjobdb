...
CREATE OR REPLACE FUNCTION pgjobdb._cancel_job(
    p_tenant_id TEXT,
    p_job_id TEXT,
    p_worker_id TEXT,
...
CREATE OR REPLACE FUNCTION pgjobdb._extend_lease(
    p_tenant_id TEXT,
    p_job_id TEXT,
    p_lease_id TEXT,
    p_worker_id TEXT,
...
BEGIN
    ...
    END IF;
    PERFORM pgjobdb._cancel_job(p_tenant_id, p_job_id, p_worker_id, p_reason);
    RETURN TRUE;
END;
$$;
